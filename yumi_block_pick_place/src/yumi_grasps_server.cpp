...
namespace moveit_simple_grasps
{
  ...
  public:
      ...
      , planning_group_name_(side_+"_arm")
    {
      ...
      if (!grasp_data_.loadRobotGraspData(nh_, side_+"_gripper")) //grasp_data_.loadRobotGraspData(nh_, side_)
        ros::shutdown();
...
int main(int argc, char *argv[])
{
  ...
  moveit_simple_grasps::GraspGeneratorServer grasp_generator_server("generate", "left"); //right
  ros::spin();
  return 0;
}
