...
/*
  ...
  curr_pose.position.x = 0.5;
  curr_pose.position.y = 0.5; //-0.7
  curr_pose.position.z = 2.5;
  geometry_msgs::PoseStamped curr_pose = move_group.getCurrentPose();
  ROS_INFO_NAMED("tutorial", "Current pose values pos x: %f", curr_pose.pose.position.x) ;
  ROS_INFO_NAMED("tutorial", "Current pose values pos y: %f", curr_pose.pose.position.y) ;
  ROS_INFO_NAMED("tutorial", "Current pose values pos z: %f", curr_pose.pose.position.z) ;
  ROS_INFO_NAMED("tutorial", "Current pose values orient w: %f", curr_pose.pose.orientation.w) ;
*/
  // Visualization
  // ^^^^^^^^^^^^^
  //
...
/*
  ...
  target_pose1.orientation.w = 0.297670;
  target_pose1.position.x = 0.0568464;
  target_pose1.position.y = 0.015869; //-0.7
  target_pose1.position.z = 1.514620;
...
/*
  ...
  ocm.link_name = "yumi_link_7_r_joint"; //r_wrist_roll_link
  ocm.header.frame_id = "link_1_r"; //base_link
