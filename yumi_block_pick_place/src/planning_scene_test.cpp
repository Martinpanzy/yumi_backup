...
int main(int argc, char **argv)
{
  ...
  attached_object.link_name = "yumi_link_7_r"; //"r_wrist_roll_link";
  /* The header must contain a valid TF frame*/
  attached_object.object.header.frame_id = "yumi_link_7_r";
  ...
  detach_object.link_name = "yumi_link_7_r"; //r_wrist_roll_link";
